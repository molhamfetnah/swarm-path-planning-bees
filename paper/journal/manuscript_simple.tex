...
\author{
Mulham Fetnah\thanks{Corresponding author. Email: mulham.fetna@alepuniv.edu.sy}\\
...
\end{equation}
where $L$ is path length, $S$ is smoothness, $C$ is clearance, and $E$ is energy consumption.
